...
Prefix decorators are separate syllables if followed by a consonant, or usually just the consonant of the decorator if followed by a vowel. The first suffix decorator elides its vowel if the root it modifies ends in a vowel (to prevent vowel-vowel adjacency).
...
diminutive or endearing | *in-* | 3 | *indag* = little *dag*; *vxincidag* = cute female puppies
...
A passive mood is expressed by replacing or following a subject with the preposition *dx* 'of/from': *d rein* 'it's raining', *i d nasdy* 'I was born'.
