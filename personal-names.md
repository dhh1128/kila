...
Examples:
- *-maria -salomea* (two given names, each marked individually)
- *-co-sofi-kn-al* (one nom kuant, marked as a single unit despite internal hyphens)
...
- If partners share the same birthday, they simply choose together which order they prefer for their *nom kuant*.
- A person can accumulate multiple *nom kuant* over a lifetime. This is uncommon with divorce, but occurs more often when a widow or widower remarries and wishes to maintain connection to a first spouse (often to preserve commonality with children from the first marriage).
- Non-romantic co-parenting partnerships typically do not use *nom kuant*, though this is a matter of personal choice.

en | kila
--- | ---
Maria Salomea Sklodowska Curie<br>aka Marie Curie née Sklodowska<br>daughter of Bronislawa and Wladislaw,<br>spouse of Pierre Curie | *nom gyvn*: *-maria*, *-salomea*<br>*nom im*: *-sklodowska*, *-curie*<br>*nom kuant* as child: *-co-broni-kn-vlad*<br>*nom kuant* as adult: *-pier-kn-mar* (used daily)<br>natal *nom kuant*: *-co-broni-kn-vlad* (retained for formal recitations)
...
An even more precise question might be *uat bi wd nom sokmplet?* 'What is your extra full name?'. This elicits an extremely formal recitation in the following order:

1. All *nom gyvn*, in order
2. The natal *nom kuant* (with *co-* prefix)
3. All standard *nom kuant* (if any), in chronological order of acquisition
4. A list of *nom im* (if any), in order of acquisition, introduced by the particle *im* 'group'
