...
1. In both isolation and sentences, multi-syllable words and base forms prefer to carry stress on the penultimate syllable. However, if the penultimate syllable's nucleus is a vocalic /lrnm/, or if it is an /x/ that isn't followed by /lrmn/ in the coda, then the preference for stress shifts to the final syllable. For example, the verb base forms *xbit* 'dwell' and *deprten* 'deprive' are stressed at the end. If the final syllable's nucleus is likewise unstressed, then the preference shifts to the antepenultimate syllable. If the antepenultimate syllable is likewise unstressed, then the penultimate is used.

    word | stress analysis
    --- | ---
    *appwtn* 'to forgive' | Remove *ap-* and *-n*, then stress single syllable of root.
    *appwtgxhq* 'had been forgiving' | Remove *ap-* and *-gx* and *-hq*, same result as before.
    *eifynyk* 'infinite' | Remove *ei-* and *-yk*, stress one-syllable root *fyn*.
    *cisyb* 'sister' | Remove *ci-*, stress one-syllable root *syb*.
    *jxgl* (hypothetical) | Prefer penultimate, but /x/ is penultimate nucleus not followed by /lrmn/, so shift to final. Final is a vocalic /l/, so shift back to penultimate.
    *xbit* 'dwell, dwelling' | Prefer penultimate, but /x/ is penultimate nucleus not followed by /lrmn/, so shift to final. Final is a strong vowel, so stress final.
    *deprtengx* 'depriving' | Remove *-gx* and *de-*. Penultimate nucleus is vocalic /r/, so stress final.
    *bxkxm* 'become' | Penultimate nucleus is /x/ not followed by /lrmn/, so shift to final. Final is also /x/, but it's followed by /m/ in the coda, so it accepts the shifted stress.
    ...
    *hikn* 'mister' | Both *hi-* and *-kn* are affixes. Keep both syllables and stress penultimate. Reinforced by the fact that final syllable nucleus is a vocalic /n/.
